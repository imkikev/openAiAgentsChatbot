...
guardrail_agent = Agent(
    ...
    instructions="Determine if the user's input is a solution architect certification or school homework question. Respond with 'is_homework': true if it is, otherwise false. Provide reasoning.",
